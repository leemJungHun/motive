...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        sendNotification(remoteMessage.getData().get("title"), remoteMessage.getData().get("content"), remoteMessage.getData().get("clickAction"));

        Log.d("openActivity",":"+remoteMessage.getData().get("clickAction"));
    }
    @Override
    ...
    private void sendNotification(String title, String content, String click_action) {
        ...
        if (click_action.equals("MainActivity")) {
            Log.d("Action","MainActivity");
            intent = new Intent(this, MainActivity.class);
        }else if(click_action.equals("LoginActivity")){
            Log.d("Action","LoginActivity");
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            final String CHANNEL_DESCRIPTION = "pushTest 채널";
